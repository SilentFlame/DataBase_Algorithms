...
def RedoUndoTwo(iA, iB, iC, iD, iE, iF):
	A = iA 
	B = iB
	C = iC
	D = iD
	...
	f1 = open('../logs/2.txt_undoredo','wa+')
...
UndoTwo(8,8,5,10,5,10)
RedoTwo(8,8,5,10,5,10)
RedoUndoTwo(8,8,5,10,5,10)
