...
def RedoUndoSix(iA, iB, iC, iD, iE, iF):
	A = iA 
	B = iB
	C = iC
	D = iD
	...
	f1 = open('../logs/6.txt_undoredo','wa+')
...
UndoSix(8,8,5,10,5,10)
RedoSix(8,8,5,10,5,10)
RedoUndoSix(8,8,5,10,5,10)
