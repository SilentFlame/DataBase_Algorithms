...
def UndoEight(iA, iB, iC, iD, iE, iF):
...
def RedoEight(iA, iB, iC, iD, iE, iF):
	A = iA 
	B = iB
	C = iC
	D = iD
...
def RedoUndoEight(iA, iB, iC, iD, iE, iF):
	A = iA 
	B = iB
	C = iC
	D = iD
	...
	f1 = open('../logs/8.txt_undoredo','wa+')
...
UndoEight(8,8,5,10,5,10)
RedoEight(8,8,5,10,5,10)
RedoUndoEight(8,8,5,10,5,10)
