...
def UndoSeven(iA, iB, iC, iD, iE, iF):
...
def RedoSeven(iA, iB, iC, iD, iE, iF):
	A = iA 
	B = iB
	C = iC
	D = iD
...
def RedoUndoSeven(iA, iB, iC, iD, iE, iF):
	A = iA 
	B = iB
	C = iC
	D = iD
	...
	f1 = open('../logs/7.txt_undoredo','wa+')
	Output = []
	Output.append("<start T1> " + printVars(A,B,C,D,E,F))
	t1=iA
	t1 = t1*2
...
UndoSeven(8,8,5,10,5,10)
RedoSeven(8,8,5,10,5,10)
RedoUndoSeven(8,8,5,10,5,10)
